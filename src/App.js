...
function App() {
  ...
  const [qrImage, changeQrImage] = useState(
    "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://github.com/dhananjaysahu79"
  );
    ...
    <div className="App">
      <div className="left">
        ...
        <h1>
          ...
          <br />
          in <span>seconds.</span>
        </h1>
        <p>
          Gencode is a dynamic QR code generator, It allows users to easily
          create <br /> customized QR codes for sharing and embedding on their
          websites.
        </p>
